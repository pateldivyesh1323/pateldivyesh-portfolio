...
const Skills = (): React.ReactElement => {
    return (
        <div className='skills-component md:min-h-screen flex items-center justify-center flex-col gap-8 mt-12'>
            <div className='font-bold text-lg underline'>
                Skills
            </div>
            <div className='flex justify-evenly w-full flex-wrap gap-6 text-sm md:text-md'>
