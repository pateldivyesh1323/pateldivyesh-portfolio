        ...
        <div className="contact-component mt-12 mb-8 flex items-center justify-center flex-col gap-8 md:min-h-screen">
            ...
            <div className="flex items-center flex-col text-sm">
                <form
                    ...
                    className="sm:w-[360px] bg-[#4c7273] p-4 md:p-8 mb-8 rounded-2xl flex items-center flex-col"
                >
                    ...
                    <div className="mb-4 w-full">
                        ...
                        <input
                            ...
                            name="name"
                            id="name"
                            className="rounded p-2 bg-[#041421] w-full"
                        />
                    </div>
                    <div className="mb-4 w-full">
                    ...
                    <div className="w-full">
                        <button
                            type="submit"
                            className="p-2 rounded bg-[#041421] float-right"
                        >
                            Send
                        </button>
                    </div>
                </form>
                <a href="mailto:pateldivyesh1323@gmail.com">
                    E-Mail: pateldivyesh1323@gmail.com
                </a>
                <Socials />
            </div>
        </div>
